...
//   const handlSelectImage = async (event) => {
//     setIsLoading(true);
...
//     setIsLoading(false);
//     formik.setFieldValue("video", videoUrl); // Fixed: changed from "image" to "video"
//   };
...
//               <Avatar src={auth.user.avatar} /> {/* Added avatar source */}
//               <div>
...
//             </div>
//             <textarea
//               className="w-full outline-none bg-transparent border border-[#3b4054] p-2 mt-5 rounded-sm"
